...
<section class="book-reviews">
    ...
    <form action="" method="post">
        <input type="text" name="search" placeholder="Enter book name..." value="<?php echo htmlspecialchars($searchQuery); ?>">
            ...
            <?php else: ?>
                <?php foreach ($searchResult as $review): ?>
                    <div class="review-item">
                        ...
                        <p class="reviewer-name"><?php echo htmlspecialchars($review['name']); ?>, <?php echo htmlspecialchars($review['job']); ?></p>
